...
The `PopoutService` singleton lets plugins control all HGS popouts and modals. It is automatically injected into widget, daemon, and settings components.
...
| Launcher | `openHGSLauncherV2()` | `closeHGSLauncherV2()` | Also has `toggleHGSLauncherV2()` |
