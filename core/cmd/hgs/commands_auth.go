...
var authCmd = &cobra.Command{
	Use:   "auth",
	Short: "Manage HGS authentication sync",
	Long:  "Manage shared PAM/authentication setup for HGS greeter and lock screen",
}

var authSyncCmd = &cobra.Command{
	Use:     "sync",
	Short:   "Sync HGS authentication configuration",
	Long:    "Apply shared PAM/authentication changes for the lock screen and greeter based on current HGS settings",
...
func syncAuth(nonInteractive bool) error {
	if !nonInteractive {
		fmt.Println("=== HGS Authentication Sync ===")
		fmt.Println()
	}
