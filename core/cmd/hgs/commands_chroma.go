...
Examples:
  hgs chroma main.go
  hgs chroma --language python script.py
  echo "def foo(): pass" | hgs chroma -l python
  cat code.rs | hgs chroma -l rust --style dracula
  hgs chroma --markdown README.md
  hgs chroma --markdown --style github-dark notes.md
  hgs chroma list-languages
  hgs chroma list-styles`,
