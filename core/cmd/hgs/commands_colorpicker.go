...
import (
	...
	"github.com/CoastLineSec/HyprGlassShell/core/internal/colorpicker"
...
See: https://coastlinesec.com/docs/hyprglassshell/keybinds-ipc`,
}
...
Examples:
  hgs color pick                # Pick color, output as hex
  hgs color pick --rgb          # Output as RGB
  hgs color pick --json         # Output all formats as JSON
  hgs color pick --hex -l       # Output hex in lowercase
  hgs color pick -a             # Auto-copy result to clipboard`,
	Run: runColorPick,
}
