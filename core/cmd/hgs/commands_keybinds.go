...
import (
	...
	"github.com/CoastLineSec/HyprGlassShell/core/internal/keybinds/providers"
...
var keybindsRemoveCmd = &cobra.Command{
	...
	Long:  "Remove a Hyprland keybind by writing a negative override to hgs/user-keybinds.lua so the key stays unbound across HGS updates.",
...
var keybindsResetCmd = &cobra.Command{
	...
	Short: "Reset a keybind override to its HGS default",
	Long:  "Drop the Hyprland user override for the given key so the HGS default re-applies.",
	Args:  cobra.ExactArgs(2),
