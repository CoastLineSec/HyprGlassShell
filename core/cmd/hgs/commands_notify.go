...
import (
	...
	"github.com/CoastLineSec/HyprGlassShell/core/internal/notify"
...
Examples:
  hgs notify "Hello" "World"
  hgs notify "File received" "photo.jpg" --file ~/Downloads/photo.jpg --icon smartphone
  hgs notify "Download complete" --file ~/Downloads/file.zip --app "My App"`,
...
func init() {
	notifyCmd.Flags().StringVar(&notifyAppName, "app", "HGS", "Application name")
