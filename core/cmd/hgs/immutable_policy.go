...
const (
	cliPolicyPackagedPath = "/usr/share/hgs/cli-policy.json"
	cliPolicyAdminPath    = "/etc/hgs/cli-policy.json"
)
...
func normalizeCommandSpec(raw string) string {
	...
	normalized = strings.TrimPrefix(normalized, "hgs ")
