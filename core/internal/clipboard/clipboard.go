...
import (
	...
	"github.com/CoastLineSec/HyprGlassShell/core/internal/proto/ext_data_control"
	wlclient "github.com/CoastLineSec/HyprGlassShell/core/pkg/go-wayland/wayland/client"
)

const envServe = "_HGS_CLIPBOARD_SERVE"
const envMime = "_HGS_CLIPBOARD_MIME"
const envPasteOnce = "_HGS_CLIPBOARD_PASTE_ONCE"
const envCacheFile = "_HGS_CLIPBOARD_CACHE"
...
func createClipboardCacheFile() (*os.File, error) {
	...
	if cacheDir, err := os.UserCacheDir(); err == nil {
		preferredDirs = append(preferredDirs, filepath.Join(cacheDir, "hgs", "clipboard"))
	}
	preferredDirs = append(preferredDirs, "/var/tmp/hgs/clipboard")

	for _, dir := range preferredDirs {
		if err := os.MkdirAll(dir, 0o700); err != nil {
			continue
		}
		cachedData, err := os.CreateTemp(dir, "hgs-clipboard-*")
		if err == nil {
			return cachedData, nil
		}
	}
	return os.CreateTemp("", "hgs-clipboard-*")
}
