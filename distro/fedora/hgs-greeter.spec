# Spec for HGS Greeter - Stable releases
...
chown -R greeter:greeter %{_localstatedir}/cache/hgs-greeter 2>/dev/null || true
...
2. Sync your theme with the greeter (optional):
     If you have HyprGlassShell (HGS) installed, you can sync theming with:
     hgs greeter sync
