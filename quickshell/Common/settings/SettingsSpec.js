...
var SPEC = {
    ...
    fluidGlassDynamicLight: { def: true },
    fluidGlassStained: { def: false },
    fluidGlassTintSource: { def: "system" },
    fluidGlassLevel: { def: 0.5, coerce: clampUnit },
    fluidGlassFrosted: { def: true },
    fluidGlassBlurCustom: { def: 0.5, coerce: clampUnit },
    fluidGlassTintCustom: { def: 0.16, coerce: clampUnit },
    fluidGlassRefraction: { def: 45 },
    fluidGlassRimBand: { def: 40 },
    fluidGlassBevel: { def: 46 },
    fluidGlassRimWidth: { def: 3 },
    fluidGlassHighlight: { def: 0.1 },
    fluidGlassShadow: { def: 0.1 },
    fluidGlassLightAngle: { def: 90 },
    fluidGlassSpecular: { def: 0.21 },
    fluidGlassRimWrap: { def: 0.45 },
    fluidGlassLabsBackdrop: { def: "" },
    fluidGlassLabsBackdrops: { def: [] },
