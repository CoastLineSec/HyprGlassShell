...
Item {
    id: root
    readonly property var log: Log.scoped("HGSModalConnected")
                ...
                Item {
                    ...
                    Item {
                        ...
                        ElevationShadow {
                            ...
                            shadowEnabled: !root.frameOwnsConnectedChrome && root.enableShadow && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("HGS_DISABLE_LAYER") !== "true" && Quickshell.env("HGS_DISABLE_LAYER") !== "1"
                        }
