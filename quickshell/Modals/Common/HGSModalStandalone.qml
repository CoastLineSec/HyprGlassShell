...
Item {
    id: root
    readonly property var log: Log.scoped("HGSModalStandalone")

    property var modalHandle: root
    property string layerNamespace: "hgs:modal"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: root.useOverlayLayer ? WlrLayer.Overlay : LayerShell.fromEnv("HGS_MODAL_LAYER", WlrLayer.Top, {
            "allow": ["top", "overlay"],
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: root.enableShadow && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("HGS_DISABLE_LAYER") !== "true" && Quickshell.env("HGS_DISABLE_LAYER") !== "1"
                    }
