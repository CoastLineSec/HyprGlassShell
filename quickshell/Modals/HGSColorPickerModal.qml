...
HGSModal {
    id: root
    readonly property var log: Log.scoped("HGSColorPickerModal")

    layerNamespace: "hgs:color-picker"
    ...
    function copyColorToClipboard(colorValue) {
        Quickshell.execDetached(["hgs", "cl", "copy", colorValue]);
    ...
    function pickColorFromScreen() {
        hideInstant();
        Proc.runCommand("hgs-color-pick", ["hgs", "color", "pick", "--json"], (output, exitCode) => {
            if (exitCode !== 0) {
                log.warn("hgs color pick exited with code:", exitCode);
                root.show();
                return;
            }
            try {
                ...
                if (result.hex) {
                    ...
                    log.warn("Failed to parse hgs color pick output: missing hex");
                    root.show();
                }
            } catch (e) {
                log.warn("Failed to parse hgs color pick JSON:", e);
                root.show();
            }
        }, 0, Proc.noTimeout);
    }
                            ...
                            Row {
                                ...
                                HGSActionButton {
                                    ...
                                    onClicked: () => {
                                        ...
                                        Quickshell.execDetached(["hgs", "cl", "copy", rgbString]);
                            ...
                            Row {
                                ...
                                HGSActionButton {
                                    ...
                                    onClicked: () => {
                                        ...
                                        Quickshell.execDetached(["hgs", "cl", "copy", hsvString]);
