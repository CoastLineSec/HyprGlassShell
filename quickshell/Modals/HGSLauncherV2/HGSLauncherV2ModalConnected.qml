...
Item {
    id: root
    readonly property var log: Log.scoped("HGSLauncherV2ModalConnected")
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: !root.frameOwnsConnectedChrome && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("HGS_DISABLE_LAYER") !== "true" && Quickshell.env("HGS_DISABLE_LAYER") !== "1"
                    }
