...
Item {
    id: root
    readonly property var log: Log.scoped("HGSLauncherV2ModalStandalone")
    ...
    readonly property bool unloadContentOnClose: SettingsData.hgsLauncherV2UnloadOnClose
    ...
    readonly property bool useSingleWindow: true
    readonly property bool usesOverlayLayer: useBackgroundDarken || SettingsData.launcherUseOverlayLayer || triggerUsesOverlayLayer
    readonly property var effectiveLauncherLayer: LayerShell.fromEnv("HGS_MODAL_LAYER", root.usesOverlayLayer ? WlrLayer.Overlay : WlrLayer.Top, {
        "allow": ["top", "overlay"],
    ...
    readonly property color borderColor: {
        if (!SettingsData.hgsLauncherV2BorderEnabled)
            return Theme.outlineMedium;
        switch (SettingsData.hgsLauncherV2BorderColor) {
        case "primary":
    ...
    readonly property int borderWidth: SettingsData.hgsLauncherV2BorderEnabled ? SettingsData.hgsLauncherV2BorderThickness : 0
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "hgs:spotlight:clickcatcher"
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "hgs:spotlight"
        WlrLayershell.layer: root.effectiveLauncherLayer
        WlrLayershell.exclusiveZone: -1
        ...
        Item {
            ...
            ElevationShadow {
                ...
                shadowEnabled: Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("HGS_DISABLE_LAYER") !== "true" && Quickshell.env("HGS_DISABLE_LAYER") !== "1"
            }
