                ...
                Rectangle {
                    ...
                    AppIconRenderer {
                        ...
                        iconValue: {
                            ...
                            if ((appId === "hgs_settings" || appId === "hgs_notepad" || appId === "hgs_sysmon") && modelData.coreAppData.cornerIcon) {
                    ...
                    IconImage {
                        ...
                        layer.enabled: appItem.appId === "org.quickshell" || appItem.appId === "io.github.coastlinesec.hgs"
                        layer.smooth: true
                        layer.mipmap: true
                    ...
                    onClicked: mouse => {
                        if (mouse.button === Qt.RightButton) {
                            ...
                            if (contextMenuLoader.item) {
                                ...
                                const shouldHidePin = modelData.appId === "org.quickshell" || modelData.appId === "io.github.coastlinesec.hgs";
                                const moddedId = Paths.moddedAppId(modelData.appId);
