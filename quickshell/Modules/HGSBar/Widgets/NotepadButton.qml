...
BasePill {
    ...
    readonly property string focusedScreenName: (typeof Hyprland !== "undefined" && Hyprland.focusedWorkspace && Hyprland.focusedWorkspace.monitor ? (Hyprland.focusedWorkspace.monitor.name || "") : "")
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "hgs:notepad-context-menu"
