...
BasePill {
    ...
    readonly property var hiddenTrayIds: {
        const envValue = Quickshell.env("HGS_HIDE_TRAYIDS") || "";
    ...
    // ! TODO - replace with either native dbus client (like plugins use) or just a HGS cli or something
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "hgs:tray-overflow-menu"
        color: "transparent"
    ...
    Component {
        ...
        Rectangle {
            ...
            PanelWindow {
                ...
                WlrLayershell.namespace: "hgs:tray-menu-window"
