...
Rectangle {
    ...
    Column {
        ...
        Rectangle {
            id: hgsWarning
            width: parent.width
            visible: CalendarService && CalendarService.hgsNeedsLaunch
            ...
            Row {
                ...
                StyledText {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    text: (CalendarService && CalendarService.hgsBinaryExists) ? I18n.tr("HGSCalendar isn't running") : I18n.tr("HGSCalendar isn't installed")
                ...
                HGSButton {
                    id: launchButton
                    anchors.verticalCenter: parent.verticalCenter
                    visible: CalendarService && CalendarService.hgsBinaryExists
                    text: I18n.tr("Launch")
                    buttonHeight: 26
                    backgroundColor: Theme.primary
                    textColor: Theme.primaryText
                    onClicked: CalendarService.launchHGSCalendar()
                }
            }
        }
