...
Item {
    ...
    Connections {
        ...
        function onSelectedBarIdChanged() {
            if (hgsBarTab.selectedBarId !== SettingsUiState.selectedBarId)
                hgsBarTab.selectedBarId = SettingsUiState.selectedBarId;
        }
    }
    ...
    HGSFlickable {
        ...
        Column {
            ...
            SettingsCard {
                tab: "appearance"
                iconName: "toolbar"
                title: I18n.tr("HGS Bar")
                settingKey: "barAppearance"
                visible: hgsBarTab.appearanceOnly

                SettingsButtonGroupRow {
                    text: I18n.tr("Editing changes on %1").arg(hgsBarTab.selectedBarName)
                    model: SettingsData.barConfigs.map((config, index) => config.name || I18n.tr("Bar %1").arg(index + 1))
                    currentIndex: {
                        const index = SettingsData.barConfigs.findIndex(config => config.id === hgsBarTab.selectedBarId);
                        return Math.max(0, index);
                    }
                    onSelectionChanged: (index, selected) => {
                        if (!selected || index < 0 || index >= SettingsData.barConfigs.length)
                            return;
                        hgsBarTab.selectedBarId = SettingsData.barConfigs[index].id;
                    }
                }
            }
            ...
            SettingsCard {
                ...
                RowLayout {
                    ...
                    HGSButton {
                        ...
                        onClicked: hgsBarTab.createNewBar()
                    }
                }
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            color: hgsBarTab.selectedBarId === modelData.id ? Theme.withAlpha(Theme.primary, 0.15) : Theme.surfaceVariant
                            border.width: hgsBarTab.selectedBarId === modelData.id ? 2 : 0
                            ...
                            Row {
                                ...
                                HGSActionButton {
                                    ...
                                    onClicked: hgsBarTab.deleteBar(barCard.modelData.id)
                                }
                            }
                            ...
                            MouseArea {
                                ...
                                onClicked: hgsBarTab.selectedBarId = barCard.modelData.id
                            }
            ...
            SettingsCard {
                ...
                visible: !hgsBarTab.appearanceOnly && selectedBarId !== "default"
                ...
                SettingsToggleRow {
                    ...
                    onToggled: toggled => hgsBarTab.toggleBarEnabled(selectedBarId)
                }
            }
            ...
            SettingsCard {
                ...
                visible: !hgsBarTab.appearanceOnly && selectedBarConfig?.enabled
            ...
            SettingsCard {
                ...
                Column {
                    ...
                    SettingsToggleRow {
                        ...
                        onToggled: checked => {
                            if (checked) {
                                hgsBarTab.setBarScreenPreferences(selectedBarId, ["all"]);
                            } else {
                                hgsBarTab.setBarScreenPreferences(selectedBarId, []);
                            }
                        }
                    }
                    ...
                    SettingsToggleRow {
                        ...
                        onToggled: checked => hgsBarTab.setBarShowOnLastDisplay(selectedBarId, checked)
                    }
                        ...
                        Repeater {
                            ...
                            delegate: SettingsToggleRow {
                                ...
                                onToggled: checked => {
                                    ...
                                    hgsBarTab.setBarScreenPreferences(selectedBarId, newPrefs);
                                }
                            }
                        }
                    }
            ...
            SettingsCard {
                ...
                Column {
                    ...
                    SettingsToggleRow {
                        width: parent.width - parent.leftPadding
                        text: I18n.tr("Strict auto-hide", "HGS bar setting: hide the bar when the pointer leaves even if a menu or bar popover is still open")
            ...
            SettingsCard {
                ...
                SettingsControlledByFrame {
                    visible: SettingsData.frameEnabled
                    parentModal: hgsBarTab.parentModal
            ...
            SettingsControlledByFrame {
                visible: hgsBarTab.appearanceOnly && SettingsData.frameEnabled
                parentModal: hgsBarTab.parentModal
            ...
            SettingsCard {
                ...
                visible: hgsBarTab.appearanceOnly && (selectedBarConfig?.enabled ?? false) && !SettingsData.frameEnabled
            ...
            SettingsSliderCard {
                ...
                description: I18n.tr("Scale HGSBar font sizes independently")
                visible: hgsBarTab.appearanceOnly && selectedBarConfig?.enabled
                minimum: 50
                maximum: 200
            ...
            SettingsSliderCard {
                ...
                description: I18n.tr("Scale HGSBar icon sizes independently")
                visible: hgsBarTab.appearanceOnly && selectedBarConfig?.enabled
                minimum: 50
                maximum: 200
            ...
            SettingsToggleCard {
                ...
                visible: hgsBarTab.appearanceOnly && selectedBarConfig?.enabled && !hgsBarTab.connectedFrameModeActive
            ...
            SettingsControlledByFrame {
                visible: hgsBarTab.appearanceOnly && hgsBarTab.connectedFrameModeActive
                parentModal: hgsBarTab.parentModal
            ...
            SettingsCard {
                ...
                collapsible: true
                expanded: false
                visible: hgsBarTab.appearanceOnly && (selectedBarConfig?.enabled ?? false) && !hgsBarTab.connectedFrameModeActive
            ...
            SettingsToggleCard {
                ...
                SettingsButtonGroupRow {
                    ...
                    model: false ? [I18n.tr("None"), I18n.tr("Workspace"), I18n.tr("Column")] : [I18n.tr("None"), I18n.tr("Workspace")]
