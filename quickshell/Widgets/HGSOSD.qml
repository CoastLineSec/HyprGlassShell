...
PanelWindow {
    id: root
    readonly property var log: Log.scoped("HGSOSD")

    property string blurNamespace: "hgs:osd"
    ...
    WlrLayershell.layer: LayerShell.fromEnv("HGS_OSD_LAYER", WlrLayer.Overlay, {
        "allow": ["top", "overlay"],
    ...
    Item {
        ...
        ElevationShadow {
            ...
            borderWidth: 1
            shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("HGS_DISABLE_LAYER") !== "true" && Quickshell.env("HGS_DISABLE_LAYER") !== "1"
        }
