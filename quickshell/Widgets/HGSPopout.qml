...
Item {
    id: root
    readonly property var log: Log.scoped("HGSPopout")
    ...
    function _triggerBarUsesOverlayLayer(targetScreen, barConfig) {
        return LayerShell.envUsesOverlay("HGS_HGSBAR_LAYER", (barConfig?.useOverlayLayer ?? false) || CompositorService.framePeerSurfacesUseOverlayForScreen(targetScreen));
    }
