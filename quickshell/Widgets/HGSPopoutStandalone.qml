...
Item {
    ...
    readonly property var log: Log.scoped("HGSPopoutStandalone")
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("HGS_DISABLE_LAYER") !== "true" && Quickshell.env("HGS_DISABLE_LAYER") !== "1" && !(root.suspendShadowWhileResizing && root._resizeActive)
                    }
