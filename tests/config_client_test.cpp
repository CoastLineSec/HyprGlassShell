...
private slots:
  ...
  void tracksConfigurationAcrossServiceLifetime() {
    ...
    QCOMPARE(client.appearanceAutomationSource(), QStringLiteral("desktop"));
    QCOMPARE(client.appearanceScheduleMode(), QStringLiteral("time"));
    QCOMPARE(client.appearanceDarkStartMinute(), 18U * 60U);
    QCOMPARE(client.appearanceLightStartMinute(), 6U * 60U);
    QCOMPARE(client.appearanceLocationSource(), QStringLiteral("manual"));
    QCOMPARE(client.appearanceHasLocation(), false);
    QCOMPARE(client.appearanceLatitude(), 0.0);
    QCOMPARE(client.appearanceLongitude(), 0.0);
    QCOMPARE(client.scheduledAppearanceMode(), QStringLiteral("system"));
    QCOMPARE(client.appearanceNextTransition(), QString());
    QCOMPARE(client.appearanceSunrise(), QString());
    QCOMPARE(client.appearanceSunset(), QString());
    QCOMPARE(client.appearanceAutomationStatus(), QStringLiteral("desktop"));
    QCOMPARE(client.nightLightEnabled(), false);
    QCOMPARE(client.nightLightAutomatic(), true);
    QCOMPARE(client.nightLightScheduleMode(), QStringLiteral("time"));
    QCOMPARE(client.nightLightDarkStartMinute(), 20U * 60U);
    QCOMPARE(client.nightLightLightStartMinute(), 6U * 60U);
    QCOMPARE(client.nightLightLocationSource(), QStringLiteral("manual"));
    QCOMPARE(client.nightLightHasLocation(), false);
    QCOMPARE(client.nightLightLatitude(), 0.0);
    QCOMPARE(client.nightLightLongitude(), 0.0);
    QCOMPARE(client.nightLightTemperature(), 4000U);
    QCOMPARE(client.nightLightDayTemperature(), 6500U);
    QCOMPARE(client.nightLightGradual(), true);
    QCOMPARE(client.hyprsunsetAvailable(), false);
    QCOMPARE(client.nightLightRuntimeState(), QStringLiteral("disabled"));
    QCOMPARE(client.nightLightCurrentTemperature(), 0U);
    QCOMPARE(client.nightLightNextTransition(), QString());
    QCOMPARE(client.nightLightSunrise(), QString());
    QCOMPARE(client.nightLightSunset(), QString());
    QCOMPARE(client.nightLightStatus(), QStringLiteral("disabled"));
    ...
    QCOMPARE(client.appearanceAutomationSource(), QStringLiteral("desktop"));
    QCOMPARE(client.nightLightEnabled(), false);
    QCOMPARE(client.hyprsunsetAvailable(), true);
    ...
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QCOMPARE(client.lastErrorName(),
             QStringLiteral("org.hyprshelld.Config1.Error.InvalidBarHeight"));
    QCOMPARE(client.lastErrorOperation(), QStringLiteral("bar-height"));
    ...
    QSignalSpy sharedBorderChanged(
        &client, &HyprShelld::ConfigClient::sharedBorderChanged);
    ...
    QCOMPARE(client.lastErrorOperation(), QStringLiteral("shared-border"));
    QVERIFY(!client.lastErrorMessage().isEmpty());
    QCOMPARE(client.shellBorderWidth(), 7U);
    QCOMPARE(client.revision(), 3ULL);

    QSignalSpy sharedSpacingChanged(
        &client, &HyprShelld::ConfigClient::sharedSpacingChanged);
    ...
    QCOMPARE(client.lastErrorOperation(), QStringLiteral("shared-spacing"));
    QVERIFY(!client.lastErrorMessage().isEmpty());
    QCOMPARE(client.shellInnerSpacing(), 0U);
    QCOMPARE(client.shellOuterSpacing(), 32U);
    QCOMPARE(client.syncHyprlandWindowSpacing(), false);
    ...
    QDBusPendingReply<qulonglong> changed =
        external.asyncCall(QStringLiteral("SetBarHeight"), 72U);
    ...
    QSignalSpy barHeightChanged(&client,
                                &HyprShelld::ConfigClient::barHeightChanged);
    QSignalSpy revisionChanged(&client,
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, malformedBorder),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), false);
    QCOMPARE(client.shellBorderEnabled(), true);
    QCOMPARE(client.shellBorderWidth(), 1U);
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, outOfRangeBorder),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), false);
    QCOMPARE(client.shellBorderWidth(), 1U);
    QCOMPARE(client.revision(), 7ULL);
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, partialSpacing),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), false);
    QCOMPARE(client.shellInnerSpacing(), 8U);
    QCOMPARE(client.revision(), 7ULL);
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, malformedSpacing),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), false);
    QCOMPARE(client.shellOuterSpacing(), 12U);
    QCOMPARE(client.revision(), 7ULL);
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, outOfRangeSpacing),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), false);
    QCOMPARE(client.shellOuterSpacing(), 12U);
    QCOMPARE(client.revision(), 7ULL);
    ...
    const auto invokeSpacingRevision =
        [&client, &noInvalidatedProperties](const qulonglong revision) {
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, QVariantMap()),
  ...
  void ownerReplacementGetAllCannotRollBackEstablishedRevision() {
    ...
    HyprShelld::ConfigClient client(bus_, nullptr);
    QVERIFY2(startService(establishedRoot.path()), qPrintable(processError_));
    QTRY_VERIFY_WITH_TIMEOUT(client.available(), 3000);
  ...
  void tracksAppearanceModeAndRejectsMalformedProjections() {
    ...
    QSignalSpy appearanceModeChanged(
        &client, &HyprShelld::ConfigClient::appearanceModeChanged);
    QSignalSpy revisionChanged(&client,
                               &HyprShelld::ConfigClient::revisionChanged);
    ...
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QTRY_COMPARE_WITH_TIMEOUT(client.appearanceMode(), QStringLiteral("light"),
                              3000);
    QCOMPARE(client.revision(), 1ULL);
    ...
    QCOMPARE(client.lastErrorOperation(), QStringLiteral("appearance-mode"));
    ...
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QTRY_COMPARE_WITH_TIMEOUT(client.appearanceMode(),
                              QStringLiteral("automatic"), 3000);
    QCOMPARE(client.revision(), 2ULL);
    QCOMPARE(appearanceModeChanged.count(), 2);

    client.resetAppearanceMode();
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QTRY_COMPARE_WITH_TIMEOUT(client.appearanceMode(), QStringLiteral("dark"),
                              3000);
    QCOMPARE(client.revision(), 3ULL);
    ...
    const QStringList noInvalidatedProperties;
    const auto inject =
        [&client, &noInvalidatedProperties](const QVariantMap &properties) {
          return QMetaObject::invokeMethod(
              &client, "propertiesChanged", Qt::DirectConnection,
              Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, properties),
              Q_ARG(QStringList, noInvalidatedProperties));
        };
    ...
    QDBusPendingReply<qulonglong> changed = external.asyncCall(
        QStringLiteral("SetAppearanceMode"), QStringLiteral("light"));
    changed.waitForFinished();
    QVERIFY2(!changed.isError(), qPrintable(changed.error().message()));
  ...
  void tracksAppearanceAutomationAndNightLightConfiguration() {
    QTemporaryDir directory;
    QVERIFY(directory.isValid());
    QVERIFY2(startService(directory.path()), qPrintable(processError_));
    ...
    QSignalSpy appearanceAutomationChanged(
        &client, &HyprShelld::ConfigClient::appearanceAutomationChanged);
    client.setAppearanceAutomation(
        QStringLiteral("schedule"), QStringLiteral("location"), 19U * 60U,
        6U * 60U + 30U, QStringLiteral("manual"), true, 51.5074, -0.1278);
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QTRY_COMPARE_WITH_TIMEOUT(appearanceAutomationChanged.count(), 1, 3000);
    QCOMPARE(client.appearanceAutomationSource(), QStringLiteral("schedule"));
    QCOMPARE(client.appearanceScheduleMode(), QStringLiteral("location"));
    QCOMPARE(client.appearanceDarkStartMinute(), 19U * 60U);
    QCOMPARE(client.appearanceLightStartMinute(), 6U * 60U + 30U);
    QCOMPARE(client.appearanceLocationSource(), QStringLiteral("manual"));
    QCOMPARE(client.appearanceHasLocation(), true);
    QCOMPARE(client.appearanceLatitude(), 51.5074);
    QCOMPARE(client.appearanceLongitude(), -0.1278);
    QCOMPARE(client.revision(), 1ULL);
    QVERIFY(client.lastErrorName().isEmpty());

    client.setAppearanceAutomation(QStringLiteral("schedule"),
                                   QStringLiteral("time"), 6U * 60U, 6U * 60U,
                                   QStringLiteral("manual"), false, 0.0, 0.0);
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QCOMPARE(client.lastErrorName(),
             QStringLiteral(
                 "org.hyprshelld.Config1.Error.InvalidAppearanceAutomation"));
    QCOMPARE(client.lastErrorOperation(),
             QStringLiteral("appearance-automation"));
    QCOMPARE(client.appearanceAutomationSource(), QStringLiteral("schedule"));
    QCOMPARE(client.appearanceScheduleMode(), QStringLiteral("location"));
    QCOMPARE(client.revision(), 1ULL);
    QCOMPARE(appearanceAutomationChanged.count(), 1);

    QSignalSpy nightLightChanged(&client,
                                 &HyprShelld::ConfigClient::nightLightChanged);
    client.setNightLightSettings(false, false, QStringLiteral("location"),
                                 21U * 60U, 7U * 60U, QStringLiteral("manual"),
                                 true, 35.6762, 139.6503, 3300U, 6800U, false);
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QTRY_COMPARE_WITH_TIMEOUT(nightLightChanged.count(), 1, 3000);
    QCOMPARE(client.nightLightEnabled(), false);
    QCOMPARE(client.nightLightAutomatic(), false);
    QCOMPARE(client.nightLightScheduleMode(), QStringLiteral("location"));
    QCOMPARE(client.nightLightDarkStartMinute(), 21U * 60U);
    QCOMPARE(client.nightLightLightStartMinute(), 7U * 60U);
    QCOMPARE(client.nightLightLocationSource(), QStringLiteral("manual"));
    QCOMPARE(client.nightLightHasLocation(), true);
    QCOMPARE(client.nightLightLatitude(), 35.6762);
    QCOMPARE(client.nightLightLongitude(), 139.6503);
    QCOMPARE(client.nightLightTemperature(), 3300U);
    QCOMPARE(client.nightLightDayTemperature(), 6800U);
    QCOMPARE(client.nightLightGradual(), false);
    QCOMPARE(client.revision(), 2ULL);
    QVERIFY(client.lastErrorName().isEmpty());

    client.setNightLightSettings(false, true, QStringLiteral("time"), 20U * 60U,
                                 6U * 60U, QStringLiteral("manual"), false, 0.0,
                                 0.0, 6001U, 6500U, true);
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QCOMPARE(client.lastErrorName(),
             QStringLiteral(
                 "org.hyprshelld.Config1.Error.InvalidNightLightSettings"));
    QCOMPARE(client.lastErrorOperation(), QStringLiteral("night-light"));
    QCOMPARE(client.nightLightTemperature(), 3300U);
    QCOMPARE(client.nightLightDayTemperature(), 6800U);
    QCOMPARE(client.revision(), 2ULL);
    QCOMPARE(nightLightChanged.count(), 1);
    ...
    client.resetAppearanceAutomation();
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    QTRY_COMPARE_WITH_TIMEOUT(client.revision(), 3ULL, 3000);
    QCOMPARE(client.appearanceAutomationSource(), QStringLiteral("desktop"));
    ...
    client.resetNightLightSettings();
    QVERIFY(client.busy());
    QTRY_VERIFY_WITH_TIMEOUT(!client.busy(), 3000);
    ...
    QSignalSpy appearanceRuntimeChanged(
        &client, &HyprShelld::ConfigClient::appearanceRuntimeChanged);
    QSignalSpy nightLightRuntimeChanged(
        &client, &HyprShelld::ConfigClient::nightLightRuntimeChanged);
    QSignalSpy revisionChanged(&client,
                               &HyprShelld::ConfigClient::revisionChanged);
    const auto revisionBeforeRuntime = client.revision();
    const QStringList noInvalidatedProperties;
    const QVariantMap appearanceRuntime{
        {QStringLiteral("ScheduledAppearanceMode"), QStringLiteral("dark")},
        {QStringLiteral("AppearanceNextTransition"),
         QStringLiteral("2030-01-02T06:00:00-05:00")},
        {QStringLiteral("AppearanceSunrise"),
         QStringLiteral("2030-01-02T07:23:00-05:00")},
        {QStringLiteral("AppearanceSunset"),
         QStringLiteral("2030-01-02T17:11:00-05:00")},
        {QStringLiteral("AppearanceAutomationStatus"),
         QStringLiteral("test-schedule")},
    };
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, appearanceRuntime),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), true);
    QCOMPARE(client.scheduledAppearanceMode(), QStringLiteral("dark"));
    QCOMPARE(client.appearanceNextTransition(),
             QStringLiteral("2030-01-02T06:00:00-05:00"));
    QCOMPARE(client.appearanceAutomationStatus(),
             QStringLiteral("test-schedule"));
    QCOMPARE(client.revision(), revisionBeforeRuntime);
    QCOMPARE(appearanceRuntimeChanged.count(), 1);
    QCOMPARE(revisionChanged.count(), 0);

    const QVariantMap nightLightRuntime{
        {QStringLiteral("HyprsunsetAvailable"), false},
        {QStringLiteral("NightLightRuntimeState"),
         QStringLiteral("test-running")},
        {QStringLiteral("NightLightCurrentTemperature"), 4321U},
        {QStringLiteral("NightLightNextTransition"),
         QStringLiteral("2030-01-02T07:00:00-05:00")},
        {QStringLiteral("NightLightSunrise"),
         QStringLiteral("2030-01-02T07:23:00-05:00")},
        {QStringLiteral("NightLightSunset"),
         QStringLiteral("2030-01-02T17:11:00-05:00")},
        {QStringLiteral("NightLightStatus"), QStringLiteral("test-status")},
    };
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, nightLightRuntime),
        Q_ARG(QStringList, noInvalidatedProperties)));
    QCOMPARE(client.available(), true);
    QCOMPARE(client.hyprsunsetAvailable(), false);
    QCOMPARE(client.nightLightRuntimeState(), QStringLiteral("test-running"));
    QCOMPARE(client.nightLightCurrentTemperature(), 4321U);
    QCOMPARE(client.nightLightNextTransition(),
             QStringLiteral("2030-01-02T07:00:00-05:00"));
    QCOMPARE(client.nightLightStatus(), QStringLiteral("test-status"));
    QCOMPARE(client.revision(), revisionBeforeRuntime);
    QCOMPARE(nightLightRuntimeChanged.count(), 1);
    QCOMPARE(revisionChanged.count(), 0);
  }
  ...
  void exposesAnExactRevisionTokenBeyondQmlIntegerPrecision() {
    ...
    QVERIFY(QMetaObject::invokeMethod(
        &client, "propertiesChanged", Qt::DirectConnection,
        Q_ARG(QString, interfaceName), Q_ARG(QVariantMap, revisionChange),
        Q_ARG(QStringList, noInvalidatedProperties)));
