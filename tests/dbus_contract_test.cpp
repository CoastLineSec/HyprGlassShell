...
QStringList describeContract(const QString &path, QString &error) {
  ...
  while (!xml.atEnd()) {
    ...
    if (xml.isStartElement()) {
      ...
      const auto element = xml.name();
      if (element == u"property" || element == u"method" ||
          element == u"signal") {
        memberKind.clear();
        memberName.clear();
      }
...
QString methodDocumentation(const QString &path, const QString &methodName,
                            QString &error) {
  ...
  const auto commentEnd =
      document.lastIndexOf(QStringLiteral("-->"), methodOffset);
  const auto commentStart =
      document.lastIndexOf(QStringLiteral("<!--"), commentEnd);
  ...
  const auto between =
      document.mid(commentEnd + 3, methodOffset - commentEnd - 3);
  ...
  return document.mid(commentStart + 4, commentEnd - commentStart - 4)
      .simplified();
}
...
private slots:
  void coordinatorContract() {
    compareContract(
        QStringLiteral(HYPRSHELLD_COORDINATOR_XML),
        {
            ...
            QStringLiteral("annotation=property:Healthy:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            QStringLiteral("property=FailedUnits:as:read"),
            QStringLiteral("annotation=property:FailedUnits:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=FailureSummary:s:read"),
            QStringLiteral("annotation=property:FailureSummary:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:true"),
  ...
  void configContract() {
    compareContract(
        QStringLiteral(HYPRSHELLD_CONFIG_XML),
        {
            ...
            QStringLiteral("annotation=property:BarHeight:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ShellBorderEnabled:b:read"),
            QStringLiteral("annotation=property:ShellBorderEnabled:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ShellBorderWidth:u:read"),
            QStringLiteral("annotation=property:ShellBorderWidth:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ShellBorderRadius:u:read"),
            QStringLiteral("annotation=property:ShellBorderRadius:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SyncHyprlandWindowBorders:b:read"),
            QStringLiteral("annotation=property:SyncHyprlandWindowBorders:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ShellInnerSpacing:u:read"),
            QStringLiteral("annotation=property:ShellInnerSpacing:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ShellOuterSpacing:u:read"),
            QStringLiteral("annotation=property:ShellOuterSpacing:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SyncHyprlandWindowSpacing:b:read"),
            QStringLiteral("annotation=property:SyncHyprlandWindowSpacing:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceMode:s:read"),
            QStringLiteral("annotation=property:AppearanceMode:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceAutomationSource:s:read"),
            QStringLiteral("annotation=property:AppearanceAutomationSource:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceScheduleMode:s:read"),
            QStringLiteral("annotation=property:AppearanceScheduleMode:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceDarkStartMinute:u:read"),
            QStringLiteral("annotation=property:AppearanceDarkStartMinute:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceLightStartMinute:u:read"),
            QStringLiteral("annotation=property:AppearanceLightStartMinute:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceLocationSource:s:read"),
            QStringLiteral("annotation=property:AppearanceLocationSource:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceHasLocation:b:read"),
            QStringLiteral("annotation=property:AppearanceHasLocation:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceLatitude:d:read"),
            QStringLiteral("annotation=property:AppearanceLatitude:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceLongitude:d:read"),
            QStringLiteral("annotation=property:AppearanceLongitude:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ScheduledAppearanceMode:s:read"),
            QStringLiteral("annotation=property:ScheduledAppearanceMode:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceNextTransition:s:read"),
            QStringLiteral("annotation=property:AppearanceNextTransition:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceSunrise:s:read"),
            QStringLiteral("annotation=property:AppearanceSunrise:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceSunset:s:read"),
            QStringLiteral("annotation=property:AppearanceSunset:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppearanceAutomationStatus:s:read"),
            QStringLiteral("annotation=property:AppearanceAutomationStatus:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightEnabled:b:read"),
            QStringLiteral("annotation=property:NightLightEnabled:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightAutomatic:b:read"),
            QStringLiteral("annotation=property:NightLightAutomatic:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightScheduleMode:s:read"),
            QStringLiteral("annotation=property:NightLightScheduleMode:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightDarkStartMinute:u:read"),
            QStringLiteral("annotation=property:NightLightDarkStartMinute:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightLightStartMinute:u:read"),
            QStringLiteral("annotation=property:NightLightLightStartMinute:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightLocationSource:s:read"),
            QStringLiteral("annotation=property:NightLightLocationSource:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightHasLocation:b:read"),
            QStringLiteral("annotation=property:NightLightHasLocation:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightLatitude:d:read"),
            QStringLiteral("annotation=property:NightLightLatitude:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightLongitude:d:read"),
            QStringLiteral("annotation=property:NightLightLongitude:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightTemperature:u:read"),
            QStringLiteral("annotation=property:NightLightTemperature:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightDayTemperature:u:read"),
            QStringLiteral("annotation=property:NightLightDayTemperature:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightGradual:b:read"),
            QStringLiteral("annotation=property:NightLightGradual:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=HyprsunsetAvailable:b:read"),
            QStringLiteral("annotation=property:HyprsunsetAvailable:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightRuntimeState:s:read"),
            QStringLiteral("annotation=property:NightLightRuntimeState:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightCurrentTemperature:u:read"),
            QStringLiteral(
                "annotation=property:NightLightCurrentTemperature:org."
                "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightNextTransition:s:read"),
            QStringLiteral("annotation=property:NightLightNextTransition:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightSunrise:s:read"),
            QStringLiteral("annotation=property:NightLightSunrise:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightSunset:s:read"),
            QStringLiteral("annotation=property:NightLightSunset:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=NightLightStatus:s:read"),
            QStringLiteral("annotation=property:NightLightStatus:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=Revision:t:read"),
            QStringLiteral("annotation=property:Revision:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            QStringLiteral("property=RecoveryState:s:read"),
            QStringLiteral("annotation=property:RecoveryState:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:const"),
            ...
            QStringLiteral(
                "arg=method:SetSharedBorder:syncHyprlandWindowBorders:b:in"),
            ...
            QStringLiteral(
                "arg=method:SetSharedSpacing:syncHyprlandWindowSpacing:b:in"),
            ...
            QStringLiteral("method=SetAppearanceAutomation"),
            QStringLiteral("arg=method:SetAppearanceAutomation:source:s:in"),
            QStringLiteral(
                "arg=method:SetAppearanceAutomation:scheduleMode:s:in"),
            QStringLiteral(
                "arg=method:SetAppearanceAutomation:darkStartMinute:u:in"),
            QStringLiteral(
                "arg=method:SetAppearanceAutomation:lightStartMinute:u:in"),
            QStringLiteral(
                "arg=method:SetAppearanceAutomation:locationSource:s:in"),
            QStringLiteral(
                "arg=method:SetAppearanceAutomation:hasLocation:b:in"),
            QStringLiteral("arg=method:SetAppearanceAutomation:latitude:d:in"),
            QStringLiteral("arg=method:SetAppearanceAutomation:longitude:d:in"),
            QStringLiteral("arg=method:SetAppearanceAutomation:revision:t:out"),
            QStringLiteral("method=ResetAppearanceAutomation"),
            QStringLiteral(
                "arg=method:ResetAppearanceAutomation:revision:t:out"),
            QStringLiteral("method=SetNightLightSettings"),
            QStringLiteral("arg=method:SetNightLightSettings:enabled:b:in"),
            QStringLiteral("arg=method:SetNightLightSettings:automatic:b:in"),
            QStringLiteral(
                "arg=method:SetNightLightSettings:scheduleMode:s:in"),
            QStringLiteral(
                "arg=method:SetNightLightSettings:darkStartMinute:u:in"),
            QStringLiteral(
                "arg=method:SetNightLightSettings:lightStartMinute:u:in"),
            QStringLiteral(
                "arg=method:SetNightLightSettings:locationSource:s:in"),
            QStringLiteral("arg=method:SetNightLightSettings:hasLocation:b:in"),
            QStringLiteral("arg=method:SetNightLightSettings:latitude:d:in"),
            QStringLiteral("arg=method:SetNightLightSettings:longitude:d:in"),
            QStringLiteral(
                "arg=method:SetNightLightSettings:nightTemperature:u:in"),
            QStringLiteral(
                "arg=method:SetNightLightSettings:dayTemperature:u:in"),
            QStringLiteral("arg=method:SetNightLightSettings:gradual:b:in"),
            QStringLiteral("arg=method:SetNightLightSettings:revision:t:out"),
            QStringLiteral("method=ResetNightLightSettings"),
            QStringLiteral("arg=method:ResetNightLightSettings:revision:t:out"),
        });
  }
  ...
  void componentManagerContract() {
    compareContract(
        QStringLiteral(HYPRSHELLD_COMPONENT_MANAGER_XML),
        {
            ...
            QStringLiteral("annotation=property:CatalogDigest:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:true"),
            ...
            QStringLiteral(
                "arg=method:GetComponent:expectedCatalogDigest:s:in"),
            ...
            QStringLiteral(
                "arg=method:GetComponent:dependencyVersionRequirements:as:out"),
            ...
            QStringLiteral(
                "arg=method:GetDeclarativeRuntime:expectedPackageDigest:s:in"),
            QStringLiteral(
                "arg=method:GetDeclarativeRuntime:expectedCatalogDigest:s:in"),
            QStringLiteral(
                "arg=method:GetDeclarativeRuntime:definition:ay:out"),
            QStringLiteral("method=BeginPackageInspection"),
            QStringLiteral(
                "arg=method:BeginPackageInspection:packageFile:h:in"),
            QStringLiteral(
                "arg=method:BeginPackageInspection:inspectionToken:s:out"),
            QStringLiteral("method=CancelPackageInspection"),
            QStringLiteral(
                "arg=method:CancelPackageInspection:inspectionToken:s:in"),
            QStringLiteral("method=InstallInspectedPackage"),
            QStringLiteral(
                "arg=method:InstallInspectedPackage:inspectionToken:s:in"),
            QStringLiteral("arg=method:InstallInspectedPackage:"
                           "expectedArchiveDigest:s:in"),
            QStringLiteral("arg=method:InstallInspectedPackage:"
                           "expectedCatalogDigest:s:in"),
            QStringLiteral(
                "arg=method:InstallInspectedPackage:componentId:s:out"),
            QStringLiteral(
                "arg=method:InstallInspectedPackage:packageDigest:s:out"),
            QStringLiteral(
                "arg=method:InstallInspectedPackage:catalogDigest:s:out"),
            QStringLiteral("method=RemovePackage"),
            QStringLiteral("arg=method:RemovePackage:componentId:s:in"),
            QStringLiteral(
                "arg=method:RemovePackage:expectedPackageDigest:s:in"),
            QStringLiteral(
                "arg=method:RemovePackage:expectedCatalogDigest:s:in"),
            QStringLiteral("arg=method:RemovePackage:catalogDigest:s:out"),
            QStringLiteral("signal=PackageInspectionFinished"),
            QStringLiteral(
                "arg=signal:PackageInspectionFinished:inspectionToken:s:"),
            ...
            QStringLiteral(
                "arg=signal:PackageInspectionFinished:errorMessage:s:"),
        });
  }
  ...
  void componentConfigContract() {
    compareContract(
        QStringLiteral(HYPRSHELLD_COMPONENT_CONFIG_XML),
        {
            ...
            QStringLiteral("annotation=property:Available:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            QStringLiteral("property=CatalogAvailable:b:read"),
            QStringLiteral("annotation=property:CatalogAvailable:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=Revision:t:read"),
            QStringLiteral("annotation=property:Revision:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            ...
            QStringLiteral("annotation=property:LoadState:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
  ...
  void componentRuntimeContract() {
    compareContract(
        QStringLiteral(HYPRSHELLD_COMPONENT_RUNTIME_XML),
        {
            ...
            QStringLiteral("annotation=property:SurfacePlanRevision:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SurfacePlanDigest:s:read"),
            QStringLiteral("annotation=property:SurfacePlanDigest:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SurfacePlanState:s:read"),
            QStringLiteral("annotation=property:SurfacePlanState:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=RuntimeHealthRevision:t:read"),
            QStringLiteral("annotation=property:RuntimeHealthRevision:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ThirdPartySafeMode:b:read"),
            QStringLiteral("annotation=property:ThirdPartySafeMode:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("method=GetSurfacePlan"),
            QStringLiteral(
                "arg=method:GetSurfacePlan:expectedSurfacePlanRevision:t:in"),
            ...
            QStringLiteral("arg=method:ListComponentRuntimeStates:"
                           "expectedRuntimeHealthRevision:t:in"),
            QStringLiteral(
                "arg=method:ListComponentRuntimeStates:componentIds:as:out"),
            QStringLiteral(
                "arg=method:ListComponentRuntimeStates:packageDigests:as:out"),
            QStringLiteral(
                "arg=method:ListComponentRuntimeStates:states:as:out"),
            QStringLiteral(
                "arg=method:ListComponentRuntimeStates:reasons:as:out"),
            QStringLiteral(
                "arg=method:ListComponentRuntimeStates:failureCounts:au:out"),
            QStringLiteral("annotation=method:ListComponentRuntimeStates:org."
                           "qtproject.QtDBus.QtTypeName.Out4:QList<uint>"),
            QStringLiteral("method=RetryComponent"),
            QStringLiteral("arg=method:RetryComponent:componentId:s:in"),
            QStringLiteral(
                "arg=method:RetryComponent:expectedPackageDigest:s:in"),
            QStringLiteral(
                "arg=method:RetryComponent:expectedRuntimeHealthRevision:t:in"),
            QStringLiteral(
                "arg=method:RetryComponent:runtimeHealthRevision:t:out"),
            ...
            QStringLiteral(
                "arg=method:ActivationStable:surfacePlanRevision:t:in"),
            QStringLiteral("method=AuthorizeSurfacePlan"),
            QStringLiteral(
                "arg=method:AuthorizeSurfacePlan:surfacePlanRevision:t:in"),
            QStringLiteral("arg=method:AuthorizeSurfacePlan:accepted:b:out"),
            QStringLiteral("method=CancelSurfacePlanAuthorization"),
            QStringLiteral("arg=method:CancelSurfacePlanAuthorization:"
                           "surfacePlanRevision:t:in"),
            QStringLiteral(
                "arg=method:CancelSurfacePlanAuthorization:cancelled:b:out"),
            ...
            QStringLiteral(
                "arg=method:ActivationFailed:surfacePlanRevision:t:in"),
  ...
  void compositorContract() {
    compareContract(
        QStringLiteral(HYPRSHELLD_COMPOSITOR_XML),
        {
            ...
            QStringLiteral("annotation=property:Writable:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            QStringLiteral("property=Revision:t:read"),
            QStringLiteral("annotation=property:Revision:org.freedesktop.DBus."
                           "Property.EmitsChangedSignal:true"),
            ...
            QStringLiteral("annotation=property:ManagementState:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=EntrypointDigest:s:read"),
            QStringLiteral("annotation=property:EntrypointDigest:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=CatalogDigest:s:read"),
            QStringLiteral("annotation=property:CatalogDigest:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ActionCatalogDigest:s:read"),
            QStringLiteral("annotation=property:ActionCatalogDigest:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=AppliedRevision:t:read"),
            QStringLiteral("annotation=property:AppliedRevision:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=ApplyState:s:read"),
            QStringLiteral("annotation=property:ApplyState:org.freedesktop."
                           "DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=RequiredActivation:s:read"),
            QStringLiteral("annotation=property:RequiredActivation:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=GenerationDigest:s:read"),
            QStringLiteral("annotation=property:GenerationDigest:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=DisplayConfirmationState:s:read"),
            QStringLiteral("annotation=property:DisplayConfirmationState:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=DisplayConfirmationRevision:t:read"),
            QStringLiteral(
                "annotation=property:DisplayConfirmationRevision:org."
                "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=DisplayConfirmationDeadlineMs:t:read"),
            QStringLiteral(
                "annotation=property:DisplayConfirmationDeadlineMs:org."
                "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=DisplayConfirmationGeneration:s:read"),
            QStringLiteral(
                "annotation=property:DisplayConfirmationGeneration:org."
                "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SharedBorderSyncState:s:read"),
            QStringLiteral("annotation=property:SharedBorderSyncState:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SharedBorderSourceRevision:t:read"),
            QStringLiteral("annotation=property:SharedBorderSourceRevision:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SharedBorderSyncError:s:read"),
            QStringLiteral("annotation=property:SharedBorderSyncError:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SharedSpacingSyncState:s:read"),
            QStringLiteral("annotation=property:SharedSpacingSyncState:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SharedSpacingSourceRevision:t:read"),
            QStringLiteral(
                "annotation=property:SharedSpacingSourceRevision:org."
                "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("property=SharedSpacingSyncError:s:read"),
            QStringLiteral("annotation=property:SharedSpacingSyncError:org."
                           "freedesktop.DBus.Property.EmitsChangedSignal:true"),
            QStringLiteral("method=GetSnapshot"),
            QStringLiteral("arg=method:GetSnapshot:snapshot:ay:out"),
            QStringLiteral("arg=method:GetSnapshot:revision:t:out"),
            ...
            QStringLiteral("arg=method:AdoptManagedConfiguration:"
                           "expectedCatalogDigest:s:in"),
            QStringLiteral("arg=method:AdoptManagedConfiguration:"
                           "expectedActionCatalogDigest:s:in"),
            QStringLiteral("arg=method:AdoptManagedConfiguration:"
                           "expectedEntrypointDigest:s:in"),
            QStringLiteral(
            ...
            QStringLiteral("arg=method:PreviewDisplayConfiguration:"
                           "expectedCatalogDigest:s:in"),
            QStringLiteral("arg=method:PreviewDisplayConfiguration:"
                           "expectedActionCatalogDigest:s:in"),
            QStringLiteral(
  ...
  void compositor2AuthorityContract() {
    const auto path =
        QFileInfo(QStringLiteral(HYPRSHELLD_COMPOSITOR_XML))
            .dir()
            .filePath(QStringLiteral("org.hyprshelld.Compositor2.xml"));
...
arg=method:AcknowledgeRepairResult:resultDigest:s:in
  ...
  void compositor2ResultRowMarshallingContract() {
    ...
    QCOMPARE(QByteArray(QDBusMetaType::typeToSignature(restartRowType)),
             QByteArrayLiteral("(tstssay)"));
    QCOMPARE(QByteArray(QDBusMetaType::typeToSignature(restartRowsType)),
             QByteArrayLiteral("a(tstssay)"));
    QCOMPARE(QByteArray(QDBusMetaType::typeToSignature(repairRowType)),
             QByteArrayLiteral("(tsssssstsay)"));
    QCOMPARE(QByteArray(QDBusMetaType::typeToSignature(repairRowsType)),
  ...
  void compositor2AuthorityDocumentationContract() {
    ...
    const auto compositor2Path =
        QFileInfo(compositor1Path)
            .dir()
            .filePath(QStringLiteral("org.hyprshelld.Compositor2.xml"));
    QString error;
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(compositor1.contains(
        QStringLiteral("never opens a revision-only mutation window")));
    QVERIFY(compositor1.contains(
        QStringLiteral("Available and Writable remain permanently false")));
    QVERIFY(compositor1.contains(QStringLiteral(
        "no legacy desired-state property tuple is authoritative")));
    QVERIFY(compositor1.contains(
        QStringLiteral("Legacy sentinel value: permanently false once "
                       "Compositor2 is present")));
    QVERIFY(compositor1.contains(
        QStringLiteral("exact readable-method allowlist is "
                       "GetConnectedDisplays and GetConnectedInputDevices")));
    QVERIFY(compositor1.contains(QStringLiteral(
        "Every other method, including all desired-state reads, catalog reads, "
        "confirmation-capability reads, and every mutation, permanently "
        "returns org.hyprshelld.Compositor1.Error.UpgradeRequired")));
    QVERIFY(compositor1.contains(
        QStringLiteral("org.hyprshelld.Compositor1.Error.UpgradeRequired")));
    QVERIFY(
        !compositor1.contains(QStringLiteral("runtime observations such as")));
    QVERIFY(!compositor1.contains(
        QStringLiteral("GetConnectedInputDevices may remain readable")));
    QVERIFY(compositor1.contains(
        QStringLiteral("must not fall back to this interface")));
    QVERIFY(compositor1.contains(
        QStringLiteral("does not widen this exhaustive allowlist")));

    const auto compositor2 = readTextFile(compositor2Path, error).simplified();
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(compositor2.contains(
        QStringLiteral("This dormant interface is served by the existing "
                       "org.hyprshelld.Compositor1 bus owner")));
    QVERIFY(compositor2.contains(
        QStringLiteral("store lease, writer, or D-Bus activation name")));

    const auto replace = methodDocumentation(
        compositor2Path, QStringLiteral("ReplaceSnapshot"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(replace.contains(
        QStringLiteral("candidate must embed exactly expectedAuthorityId and "
                       "expectedRevision")));
    QVERIFY(
        replace.contains(QStringLiteral("AuthorityId is checked before either "
                                        "catalog digest and before revision")));
    QVERIFY(replace.contains(
        QStringLiteral("current verified Config1 projection")));
    QVERIFY(replace.contains(
        QStringLiteral("exact unique final protected maximized-window rule")));

    const auto optionCatalog = methodDocumentation(
        compositor2Path, QStringLiteral("GetOptionCatalog"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(optionCatalog.contains(
        QStringLiteral("one coherent retained authority tuple")));
    ...
    QVERIFY(actionCatalog.contains(
        QStringLiteral("never reopens their source paths")));
    QVERIFY(actionCatalog.contains(
        QStringLiteral("one coherent retained authority tuple")));
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(inputDevices.contains(
        QStringLiteral("fresh authenticated `j/devices` query")));
    QVERIFY(inputDevices.contains(
        QStringLiteral("old observations are not cached as current")));
    ...
    for (const auto &methodName :
      ...
      const auto documentation =
          methodDocumentation(compositor2Path, methodName, error);
      QVERIFY2(error.isEmpty(), qPrintable(error));
      QVERIFY2(documentation.contains(QStringLiteral("expectedAuthorityId")),
               qPrintable(methodName));
      QVERIFY2(
          documentation.contains(QStringLiteral("expectedPreviewRevision")),
          qPrintable(methodName));
      ...
      QVERIFY2(documentation.contains(QStringLiteral(
               ...
               qPrintable(methodName));
      QVERIFY2(documentation.contains(
                   QStringLiteral("catalog digest, and action-catalog digest")),
               qPrintable(methodName));
      QVERIFY2(documentation.contains(QStringLiteral(
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(restartPlan.contains(
        QStringLiteral("operationKind apply or recovery")));
    QVERIFY(restartPlan.contains(
        QStringLiteral("at most 64 unexpired plans and 4 MiB")));
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(authorizeRestart.contains(QStringLiteral("prepared-authorized")));
    QVERIFY(authorizeRestart.contains(QStringLiteral("StalePlan")));
    QVERIFY(authorizeRestart.contains(
        QStringLiteral("request lookup precedes current-authority CAS")));

    for (const auto &methodName : {QStringLiteral("GetRestartOperation"),
    ...
    QVERIFY(restartResults.contains(
        QStringLiteral("latest acknowledged result is returned explicitly")));
    ...
    QVERIFY(acknowledgeRestart.contains(
        QStringLiteral("retains that result as the explicitly queryable latest "
                       "acknowledged")));

    for (const auto &methodName : {QStringLiteral("RetrySharedBorderSync"),
                                   QStringLiteral("RetrySharedSpacingSync")}) {
      const auto documentation =
          methodDocumentation(compositor2Path, methodName, error);
      QVERIFY2(error.isEmpty(), qPrintable(error));
      QVERIFY2(documentation.contains(QStringLiteral("CAS errors")),
               qPrintable(methodName));
      QVERIFY2(documentation.contains(QStringLiteral(
                   "org.hyprshelld.Compositor2.Error.StaleAuthority")),
               qPrintable(methodName));
    ...
    QVERIFY(
        status.contains(QStringLiteral("V1 carries its exact observed revision "
                                       "without an invented authority ID")));
    QVERIFY(status.contains(
        QStringLiteral("V2 carries its exact authority ID and revision")));
    QVERIFY(status.contains(QStringLiteral(
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(restorePlan.contains(
        QStringLiteral("complete prior authority is provably recoverable")));
    QVERIFY(restorePlan.contains(
        QStringLiteral("client-generated request ID before confirmation")));
    QVERIFY(restorePlan.contains(
        QStringLiteral("does not restore or mutate any state")));

    const auto restore = methodDocumentation(
        compositor2Path, QStringLiteral("RestoreExactPrior"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(restore.contains(QStringLiteral("complete exact prior authority")));
    QVERIFY(restore.contains(QStringLiteral("permanent request tombstone")));
    QVERIFY(restore.contains(QStringLiteral(
        "request ID, plan ID, plan digest, and disclosure version")));
    QVERIFY(restore.contains(
        QStringLiteral("restored authority kind, ID, and revision")));
    QVERIFY(restore.contains(QStringLiteral("repair-result ID and digest")));
    ...
    QVERIFY(resetPlan.contains(
        QStringLiteral("client-generated request ID before confirmation")));
    QVERIFY(resetPlan.contains(
        QStringLiteral("org.hyprshelld.Compositor2.Error.ExactPriorRequired")));

    const auto reset = methodDocumentation(
        compositor2Path, QStringLiteral("ResetAuthorityToDefaults"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(reset.contains(
        QStringLiteral("complete descriptor-relative, fsynced archive")));
    ...
    QVERIFY(reset.contains(
        QStringLiteral("expectedAuthorityKind v1, absent, or unreadable")));
    QVERIFY(reset.contains(QStringLiteral("no Applied or LastGood claim")));
    QVERIFY(reset.contains(QStringLiteral("repair-result ID and digest")));
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(lookupRepair.contains(
        QStringLiteral("active, unread-result, latest-acknowledged")));
    QVERIFY(lookupRepair.contains(QStringLiteral("tombstone-only")));
    QVERIFY(lookupRepair.contains(
        QStringLiteral("repairResultId is already reserved")));
    ...
    QVERIFY(repairResults.contains(
        QStringLiteral("latest acknowledged result is returned explicitly")));
    ...
    QVERIFY(acknowledgeRepair.contains(
        QStringLiteral("retains that result as the explicitly queryable latest "
                       "acknowledged")));

    const auto contract = describeContract(compositor2Path, error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QCOMPARE(contract.count(QStringLiteral(
                 "arg=method:ResetAuthorityToDefaults:requestId:s:in")),
             1);
    ...
    for (const auto &forbidden : {QStringLiteral("method=AdvanceRestartPhase"),
    ...
    const auto readmePath =
        QFileInfo(compositor2Path).dir().filePath(QStringLiteral("README.md"));
    const auto readme = readTextFile(readmePath, error).simplified();
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(readme.contains(
        QStringLiteral("`org.hyprshelld.Compositor1` destination at "
                       "`/org/hyprshelld/Compositor2` with interface "
                       "`org.hyprshelld.Compositor2`")));
    QVERIFY(readme.contains(
        QStringLiteral("one activation name, one compositord process, one "
                       "store lease, and one writer")));
    ...
    QVERIFY(readme.contains(QStringLiteral(
        "no legacy desired-state property tuple is authoritative")));
    QVERIFY(readme.contains(QStringLiteral(
        "exact readable-method allowlist is `GetConnectedDisplays` and "
    ...
    QVERIFY(readme.contains(QStringLiteral(
        ...
        "returns `org.hyprshelld.Compositor1.Error.UpgradeRequired`")));
    QVERIFY(!readme.contains(
        QStringLiteral("runtime observations may remain readable")));
    QVERIFY(readme.contains(QStringLiteral(
        "reviewed Restart methods are part of that dormant ABI")));
    QVERIFY(readme.contains(QStringLiteral(
        "no public phase-advance, Cancel, or RestartUnit method exists")));
    QVERIFY(!readme.contains(
        QStringLiteral("Restart authorization methods remain absent")));
    QVERIFY(readme.contains(QStringLiteral(
        "`GetOptionCatalog` returns five values in this exact order")));
    QVERIFY(readme.contains(QStringLiteral(
        "`GetActionCatalog` returns seven values in this exact order")));
    QVERIFY(
        readme.contains(QStringLiteral("Each getter returns one coherent "
                                       "retained in-memory authority tuple")));
    QVERIFY(readme.contains(
        QStringLiteral("`availability` is exactly `active`, `unread-result`, "
                       "`latest-acknowledged`, or `tombstone-only`")));
    QVERIFY(readme.contains(QStringLiteral(
        "`limit` is 1 through 64 and the complete reply is at most 4 MiB")));
    QVERIFY(readme.contains(
        QStringLiteral("latest acknowledged result is returned explicitly even "
                       "when no unread result remains")));
    QVERIFY(readme.contains(
        QStringLiteral("`AcknowledgeRepairResult` binds the exact "
                       "repair/repair-result/authority-kind")));
    QVERIFY(readme.contains(
        QStringLiteral("`observedAuthorityKind`, `observedAuthorityId`, "
                       "`observedRevision`, and `statusDigest")));
    QVERIFY(readme.contains(QStringLiteral(
        "kind is exactly `v1`, `v2`, `absent`, or `unreadable`")));
    QVERIFY(readme.contains(
        QStringLiteral("`GetExactPriorRestorePlan` has priority")));
    QVERIFY(readme.contains(QStringLiteral(
        "request ID appears exactly once and precedes the plan fields")));
    QVERIFY(readme.contains(
        QStringLiteral("complete descriptor-relative, fsynced archive")));
    QVERIFY(readme.contains(
        QStringLiteral("No second repair daemon or writer exists")));
  }
  ...
  void compositorSharedVisualDocumentationContract() {
    ...
    QVERIFY(xml.contains(
        QStringLiteral("zero while the Config1 source is unavailable")));

    const auto replace =
        methodDocumentation(path, QStringLiteral("ReplaceSnapshot"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(replace.contains(QStringLiteral("ControlledByHyprShelld")));
    QVERIFY(replace.contains(
        QStringLiteral("current verified Config1 projection")));
    QVERIFY(
        replace.contains(QStringLiteral("retained last verified projection")));
    QVERIFY(
        replace.contains(QStringLiteral("current desired resolved values")));
    QVERIFY(replace.contains(
        QStringLiteral("exact unique final protected maximized-window rule")));

    const auto apply =
        methodDocumentation(path, QStringLiteral("Apply"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(apply.contains(QStringLiteral("ControlledByHyprShelld")));
    QVERIFY(apply.contains(QStringLiteral(
        "currently verified, available Config1 shared-visual authority")));
    QVERIFY(
        apply.contains(QStringLiteral("even when the last verified border or "
                                      "spacing policy was an override")));
    ...
    QVERIFY(
        adopt.contains(QStringLiteral("even when the last verified border or "
                                      "spacing policy was an override")));
    QVERIFY(adopt.contains(
        QStringLiteral("exact protected maximized-window rule")));

    const auto recover =
        methodDocumentation(path, QStringLiteral("Recover"), error);
    QVERIFY2(error.isEmpty(), qPrintable(error));
    ...
    QVERIFY(retry.contains(
        QStringLiteral("effective Config1 shared policy or derived compositor "
                       "border values change")));
    ...
    QVERIFY(spacingRetry.contains(
        QStringLiteral("protected maximized-window rule")));
    QVERIFY(
        spacingRetry.contains(QStringLiteral("Revision-only source update")));
    QVERIFY(spacingRetry.contains(QStringLiteral("without retrying")));

    const auto readmePath =
        QFileInfo(path).dir().filePath(QStringLiteral("README.md"));
    const auto readme = readTextFile(readmePath, error).simplified();
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(readme.contains(
        QStringLiteral("requires a currently verified, available Config1 "
                       "shared-visual authority")));
    QVERIFY(
        readme.contains(QStringLiteral("even when the last verified border or "
                                       "spacing policy was an override")));
    QVERIFY(
        readme.contains(QStringLiteral("Recover is intentionally exempt from "
                                       "the shared-visual ownership gate")));
    QVERIFY(readme.contains(QStringLiteral(
        "current verified Config1 projection, then the retained last verified "
        "projection, then the current desired resolved values")));
    QVERIFY(readme.contains(
        QStringLiteral("exact unique final protected maximized-window rule")));
    QVERIFY(readme.contains(QStringLiteral(
        "SharedSpacingSyncError`, and `RetrySharedSpacingSync`")));
    QVERIFY(readme.contains(
        QStringLiteral("Config1 projection Revision-only change")));
  ...
  void compositorInputDeviceDiscoveryContract() {
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(method.contains(
        QStringLiteral("fresh authenticated `j/devices` query")));
    QVERIFY(method.contains(
        QStringLiteral("Raw runtime addresses are retained only in the private "
                       "opaque inventory fingerprint and never cross D-Bus")));
    QVERIFY(method.contains(QStringLiteral(
        "independent of desired-state and managed-filesystem authority")));
    QVERIFY(method.contains(
        QStringLiteral("unavailable while a display confirmation capability "
                       "still exists or its durable commit is active")));
    QVERIFY(method.contains(
        QStringLiteral("old observations are not cached as current")));
    for (const auto &name :
         {QStringLiteral("Unavailable"), QStringLiteral("RuntimeUnavailable"),
          QStringLiteral("UnsupportedVersion"),
          QStringLiteral("VerificationFailed")}) {
      QVERIFY2(method.contains(
                   QStringLiteral("org.hyprshelld.Compositor1.Error.") + name),
               qPrintable(name));
    }
    ...
    QVERIFY2(error.isEmpty(), qPrintable(error));
    QVERIFY(readme.contains(
        QStringLiteral("separate authenticated read-only authority")));
    QVERIFY(readme.contains(
        QStringLiteral("configured reviewed Hyprland 0.56.x policy")));
    QVERIFY(readme.contains(
        QStringLiteral("canonical v1 inventory plus its observation time")));
    QVERIFY(
        readme.contains(QStringLiteral("random compositord-process epoch")));
    QVERIFY(readme.contains(
        QStringLiteral("does not require an available desired snapshot, "
                       "managed entrypoint ownership, activation filesystem "
                       "binding, or successful activation finalization")));
    QVERIFY(readme.contains(
        QStringLiteral("display confirmation capability still exists or its "
                       "durable commit is active")));
    QVERIFY(readme.contains(
        QStringLiteral("terminal failed state without a retained capability "
                       "does not permanently block later discovery")));
    QVERIFY(readme.contains(QStringLiteral(
