...
TestSystemdUnitRecords completeSnapshot()
{
    return {
        ...
        unitRecord(compositorUnit, QStringLiteral("active")),
...
private slots:
    ...
    void defaultsAndExplicitRefresh()
    {
        ...
        QCOMPARE(status.compositorState(), QStringLiteral("unknown"));
        ...
        QCOMPARE(status.compositorState(), QStringLiteral("active"));
    ...
    void activePollingStopsWhenInactive()
    {
        ...
        updated[4].activeState = QStringLiteral("failed");
        updated[5].activeState = QStringLiteral("active");
        ...
        QCOMPARE(status.compositorState(), QStringLiteral("failed"));
    ...
    void reportsLoadFailureInsteadOfInactiveState()
    {
        ...
        records[5].loadState = QStringLiteral("masked");
        records[5].activeState = QStringLiteral("inactive");
        ...
        QCOMPARE(status.compositorState(), QStringLiteral("masked"));
